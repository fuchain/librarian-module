    ...
    return (
      <div className="parent">
        ...
        >
          ...
          <span className="blockNo" id={"title-" + this.props.block}>
            #{this.props.block}
          </span>
        </div>
        <div
          id={this.props.block}
          style={blockStyle}
          className="four wide column bgreen cards box"
        >
          <span
            id={"back-" + this.props.block}
            className={this.props.block + " dot back"}
          >
            {this.props.prevBlock && <div className="line" />}
          </span>
          <span
          ...
          {this.props.state.map((value, index) => {
            return (
              <Transaction key={value} txId={value} block={this.props.block} />
            );
          })}
        </div>
      </div>
