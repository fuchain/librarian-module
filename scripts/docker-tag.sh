...
docker tag bigchaindb_bigchaindb:latest fptudev/fuchain:latest
docker tag fuchain_bigchaindb:latest fptudev/fuchain:latest
...
docker push fptudev/fuchain:latest
